    ...
    <Card sx={styles.pricingBox} className={  header ? "package__card active" : "package__card" }>
        ...
        <Box>
            <Box className="package__header" sx={styles.pricingHeader}>
                  <Heading className="pricing__Name" variant="title" > { name } </Heading>
            ...
            <Text className='package__price' sx={styles.price}>
              ...
              <Box sx={styles.buttonGroup}>
                  ...
                  { anotherOption && (
                    <Button variant='textButton' aria-label={anotherOption} className='free__trial' sx={{ color: "black" }} > { anotherOption } 
                    </Button>
                  ) }
              </Box>
          </Box>
